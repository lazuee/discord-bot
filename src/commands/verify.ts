			...
			case "captcha":
				{
					...
					const embed = new EmbedBuilder().setTitle("Are you human?").setDescription("please enter the captcha code to get access!").setColor("#2f3136").setImage(`attachment://${text}.png`).setFooter({ text: "Verification Period: 2 minutes" });
